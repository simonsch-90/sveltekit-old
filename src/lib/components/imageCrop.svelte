<script lang="ts">
	...
	import type { CropShape, DispatchEvents, ImageSize, Point, Size } from '$lib/types';
	import {
		getCropSize,
		restrictPosition,
	...
	export let zoom = 1;
	export let aspectRatio = { width: 3, height: 4 };
	...
	export let isRestrictPosition = true;
	...
	const emitCropData = () => {
		...
		const position = isRestrictPosition
